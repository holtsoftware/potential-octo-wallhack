========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Proxi
========================================================================


AppWizard has created this Proxi application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Proxi application.
...
res\Proxi.ico
    ...
    icon is included by the main resource file Proxi.rc.
...
ProxiDlg.h, ProxiDlg.cpp - the dialog
    These files contain your CProxiDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Proxi.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CProxiDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Proxi.pch and a precompiled types file named StdAfx.obj.
