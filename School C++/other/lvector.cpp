...
template<class T>
lvector<T>::lvector(int size,const T &fillvalue)
...
template<class T>
lvector<T>::lvector(lvector &tcopy)
...
template<class T>
long int lvector<T>::length() const
//PostCondtion: returns the size of the link list
{
	return mylength;
}
...
template<class T>
const T & lvector<T>::atc(int index) const
//PreCondition: 0 <= K < length()
//PostCondition: returns the index item
{
	NODE<T> *temp;
...
template<class T>
T & lvector<T>::operator [](int index)
//See atc() or at()
{
	return at(index);
}
...
/////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
const lvector<T> & lvector<T>::operator =(const lvector<T> &rhs)
