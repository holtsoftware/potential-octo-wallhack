// day 8Dlg.cpp : implementation file
//
...
CDay8Dlg::CDay8Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CDay8Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDay8Dlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDay8Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CDay8Dlg, CDialog)
	//{{AFX_MSG_MAP(CDay8Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
