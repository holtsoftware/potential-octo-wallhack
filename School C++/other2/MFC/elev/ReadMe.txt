========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : elev
========================================================================


AppWizard has created this elev application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your elev application.
...
res\elev.ico
    ...
    icon is included by the main resource file elev.rc.
...
elevDlg.h, elevDlg.cpp - the dialog
    These files contain your CElevDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in elev.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CElevDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named elev.pch and a precompiled types file named StdAfx.obj.
